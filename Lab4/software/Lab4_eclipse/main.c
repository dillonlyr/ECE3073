...
volatile int * Output_LEDR = (int *) 0x04041090; // LED[8]

// MSB PIO addresses
volatile int * Input_MSB = (int *) 0x04041060; // MSB
volatile int * Input_MSB_IRQ = (int *) 0x04041068;
volatile int * Input_MSB_EDGECAPTURE = (int *) 0x0404106C;
