...
# setting hal.stderr is Core2_JTAG_UART
ELF_PATCH_FLAG  += --stderr_dev Core2_JTAG_UART

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is Core2_JTAG_UART
ELF_PATCH_FLAG  += --stdin_dev Core2_JTAG_UART
...
# setting hal.stdout is Core2_JTAG_UART
ELF_PATCH_FLAG  += --stdout_dev Core2_JTAG_UART
