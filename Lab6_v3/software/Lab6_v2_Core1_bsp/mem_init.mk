...
# Memory: Core1_RAM
MEM_0 := Lab6_v2_NiosProc_Core1_RAM
$(MEM_0)_NAME := Core1_RAM
...
$(MEM_0)_HIERARCHICAL_PATH := Core1_RAM
$(MEM_0)_WIDTH := 32
...
.PHONY: Core1_RAM
Core1_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
