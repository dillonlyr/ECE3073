...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Lab6_v2_NiosProc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Lab6_v2_NiosProc
SOPC_NAME := Lab6_v2_NiosProc
...
# setting hal.stderr is Core1_JTAG_UART
ELF_PATCH_FLAG  += --stderr_dev Core1_JTAG_UART

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is Core1_JTAG_UART
ELF_PATCH_FLAG  += --stdin_dev Core1_JTAG_UART
...
# setting hal.stdout is Core1_JTAG_UART
ELF_PATCH_FLAG  += --stdout_dev Core1_JTAG_UART
